...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\Work\\airwatch-plugin");
    parameters.put("artifactId","airwatch-plugin");
    parameters.put("outputDirectory","C:\\Work\\airwatch-plugin\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Work\\airwatch-plugin\\target\\test-classes");
